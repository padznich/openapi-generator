...
class RESTResponse(io.IOBase):
    ...
    def __init__(self, resp: urllib3.BaseHTTPResponse) -> None:
        self.response = resp
...
class RESTClientObject:
    ...
    def request(
        ...
        body: Any = None,
        post_params: Optional[Union[list[tuple[str, Any]], dict[str, Any]]] = None,
        _request_timeout: Optional[Union[int, float, tuple[Union[int, float], Union[int, float]]]] = None,
    ) -> RESTResponse:
        """Perform requests.
